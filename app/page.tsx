        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            ...
            <div className="flex-shrink-0 w-full lg:w-64">
              ...
              <a href="#" className="mt-3 flex items-center justify-center gap-2 px-4 py-3 bg-violet-600 hover:bg-violet-500 text-white font-bold rounded-lg transition-all text-sm">
                Descargar CV ↓
              </a>
            </div>
            {/* Main */}
            <div className="flex-1">
              ...
              <div className="space-y-4 text-zinc-400 leading-relaxed mb-10">
                ...
                <p>Me desenvuelvo muy bien diseñando la lógica del servidor y trabajando con tecnologías como Python y Node. Me gusta el código ordenado, las arquitecturas limpias y tengo gran facilidad para adoptar nuevas tecnologías a medida que la industria avanza.</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <a key={opt.label} href={opt.href}
                ...
                className={`flex flex-col gap-3 p-5 bg-zinc-900 border ${opt.border} rounded-xl transition-all group`}>
                <div className={`p-2.5 rounded-lg ${opt.bgIcon} ${opt.textIcon} w-fit group-hover:scale-110 transition-transform`}>{opt.icon}</div>
                <div>
